...
from datasets import Unreal_Extrapolation_Dataset
...
def train(args, ddp_model):
    ...
    dataset_train = Unreal_Extrapolation_Dataset(config.dataDir, augment=True)
    ...
    for epoch in range(args.resume_epoch, args.epochs):
        ...
        for i, data in enumerate(dataloader_train):
            ...
            if (iters+1) % 100 == 0 and local_rank == 0:
                ...
                saveExr(os.path.join(img_path, '{:08d}_img1.exr'.format(iters)), img1[0])
